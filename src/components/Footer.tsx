      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 px-12 py-20 max-w-7xl mx-auto">
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2">
            ...
            <li><Link className="text-on-surface-variant hover:text-on-surface transition-colors text-sm" href="#">Global Citizenship</Link></li>
          </ul>
        </div>
        <div className="space-y-4">
          ...
          <ul className="space-y-2">
            ...
            <li><Link className="text-on-surface-variant hover:text-on-surface transition-colors text-sm" href="#">Insights</Link></li>
          </ul>
        </div>
        <div className="space-y-4">
          <div className="font-label text-sm uppercase tracking-widest text-primary font-bold">Legal</div>
          <ul className="space-y-2">
            <li><Link className="text-on-surface-variant hover:text-on-surface transition-colors text-sm" href="#">Privacy Policy</Link></li>
            <li><Link className="text-on-surface-variant hover:text-on-surface transition-colors text-sm" href="#">Terms of Service</Link></li>
            <li><Link className="text-on-surface-variant hover:text-on-surface transition-colors text-sm" href="#">Compliance</Link></li>
